        ...
        private static void InitUI()
        {
            if (Instance == null)
            {
                ...
                if (modelSelectorPrefab != null)
                {
                    ...
                    var modelSelectorUI = modelSelectorInstance.AddComponent<ModelSelectorUI>();
                    ...
                    modelSelectorUI.buttonPrefab = HelperTools.LoadUIPrefab("VariantButtonPrefab");
                    modelSelectorUI.modelPreviewPrefab = HelperTools.LoadUIPrefab("ModelPreviewPrefab");
                    Instance = modelSelectorUI;
                }
                else
                {
                    LethalModelSwitcher.Logger.LogError("Failed to load LMSCanvas prefab.");
                }
            }
        }
